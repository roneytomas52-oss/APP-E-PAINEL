...
class ConfigController extends Controller
{
    ...
    public function rideConfigs() {
        $keys = [
            'rider_can_review_customer',
            'safety_feature_status',
            'ride_safety_delay_time',
            'ride_safety_delay_time_format',
            'safety_feature_after_ride_complete_status',
            'safety_feature_after_ride_complete_time',
            'safety_feature_after_ride_complete_time_format',
            'emergency_govt_number',
            'ride_commission',
            'search_radius',
            'rider_completion_radius',
            'bid_on_fare',
            'rider_referal_status',
            'ride_otp_confirmation',
            'ride_request_active_time',
            'toggle_rider_registration',
            'show_rider_earning',
            'rider_level_status',
            'rider_tips_status',
            'cash_in_hand_overflow_rider',
            'rider_max_cash_in_hand',
            'min_amount_to_pay_rider',
            'rider_loyality_point_status',
            'rider_loyality_point_conversion_rate',
            'rider_min_loyality_point_to_convert',
            'rider_referal_amount',
            'rider_referal_bonus',
