...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $landing_data = [
            ...
            'earning_rider_image' => (isset($settings['earning_rider_image']))  ? $settings['earning_rider_image'] : null,
            'earning_rider_image_storage' => (isset($settings['earning_rider_image_storage']))  ? $settings['earning_rider_image_storage'] : 'public',
            ...
            'rider_app_earning_links' => (isset($settings['rider_app_earning_links']))  ? json_decode($settings['rider_app_earning_links'], true) : null,
