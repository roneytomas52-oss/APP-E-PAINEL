    ...
    <section class="earn-money-section z-2">
        ...
        <div class="container">
            ...
            @if(addon_published_status('RideShare'))
                ...
                <div class="earn-item wow fadeInUp">
                    <div class="earn-item-img"
                        style="background: url({{ \App\CentralLogics\Helpers::get_full_url('earning', isset($landing_data['earning_rider_image']) ? $landing_data['earning_rider_image'] : null, isset($landing_data['earning_rider_image_storage']) ? $landing_data['earning_rider_image_storage'] : 'public') }}) no-repeat center center / cover;">
                        <div class="position-relative dropdown text-capitalize z-2">

                            @if (isset($join_as_rider['playstore_url_status']) &&
                                    $join_as_rider['playstore_url_status'] == '1' &&
                                    isset($join_as_rider['apple_store_url_status']) &&
                                    $join_as_rider['apple_store_url_status'] == '1')
                                <button type="button" class="cmn--btn border-0" data-bs-toggle="dropdown">
                                    {{ translate('Rider App') }}
                                    <svg class="ms-2" width="12" height="7" viewBox="0 0 12 7"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="dropdown-menu p-0">
                                    <a href="{{ isset($join_as_rider['playstore_url']) ? $join_as_rider['playstore_url'] : '' }}"
                                        class="dropdown-item">
                                        <img src="{{ asset('/public/assets/landing/img/google-play.png') }}"
                                            alt="">
                                        {{ translate('google_play') }}
                                    ...
                                    <a href="{{ isset($join_as_rider['apple_store_url']) ? $join_as_rider['apple_store_url'] : '' }}"
                                        class="dropdown-item">
                                        <img src="{{ asset('/public/assets/landing/img/apple-store.png') }}"
                                            alt="">
                                        {{ translate('apple_store') }}
                            ...
                            @elseif(isset($join_as_rider['playstore_url_status']) && $join_as_rider['playstore_url_status'] == '1')
                                <a type="button"
                                    href="{{ isset($join_as_rider['playstore_url']) ? $join_as_rider['playstore_url'] : '' }}"
                                    class="cmn--btn border-0">
                                    {{ translate('Deliveryman App') }}
                                </a>
                            @elseif(isset($join_as_rider['apple_store_url_status']) && $join_as_rider['apple_store_url_status'] == '1')
                                <a type="button"
                                    href="{{ isset($join_as_rider['apple_store_url']) ? $join_as_rider['apple_store_url'] : '' }}"
                                    class="cmn--btn border-0">
                                    {{ translate('Deliveryman App') }}
                                </a>
                            @endif
                    ...
                    <div class="earn-item-cont">
                        <div>
                            <h4 class="subtitle">{{ translate('messages.Become a smart') }}</h4>
                            <h3 class="title">{{ translate('messages.Rider') }}</h3>
                        </div>
                    </div>
                </div>
            @endif
                        ...
                        <div class="left-side">
                            ...
                            @if(addon_published_status('RideShare'))
                                <div class="counter-item wow fadeInUp">
                                    ...
                                    <h4 class="title"> <span class=" odometer"
                                            data-odometer-final="{{ $counter['rider_count_numbers'] ?? 0 }}"></span>
                                        <span>+</span>
                                    </h4>
                                    <div class="text">{{ translate('messages.Rider') }}</div>
                                </div>
                            @endif
                            <div class="counter-item wow fadeInUp">
                                <div class="icon">
