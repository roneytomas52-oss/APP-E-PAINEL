    ...
    <section class="about-section py-5 position-relative">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="title mb-2">{{translate("messages.Rider")}} <span class="text--base">{{translate("messages.Application")}}</span></h2>
            </div>
            <!-- End Page Header -->
                <form class="validate-form" action="{{ route('rider.store') }}" method="post" enctype="multipart/form-data" id="form-id">
                    ...
                    <div class="card __card mb-3">
                        <div class="card-header">
                            ...
                            </svg>{{ translate('messages.rider_info') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="f_name" id="f_name" class="form-control __form-control"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <small
                                            class="text-danger">*</small> </label>
                                        <input type="text" name="l_name" id="l_name" class="form-control __form-control"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="email">{{ translate('messages.email') }}
                                        <small
                                            class="text-danger">*</small> </label>
                                        <input type="email" name="email" id="email" class="form-control __form-control"
                                            placeholder="{{ translate('messages.Ex:') }} ex@example.com" value="{{ old('email') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6" id="ref_code">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="referral_code">{{ translate('messages.referral_code') }}
                                        </label>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="zone_id">{{ translate('messages.zone') }}
                                        <small
                                            class="text-danger">*</small> </label>
                                        <select name="zone_id" id="zone_id" class="form-control __form-control" required
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="identity_type">{{ translate('messages.identity_type') }}
                                            <small
                                            class="text-danger">*</small> </label>
                                        <select name="identity_type" id="identity_type" class="form-control __form-control">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="identity_number">{{ translate('messages.identity_number') }}
                                        <small
                                            class="text-danger">*</small> </label>
                                        <input type="text" name="identity_number" id="identity_number" class="form-control __form-control"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="password">{{ translate('messages.password') }}
                                            <small
        ...
        data-original-title="{{ translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters') }}"></span></label>
                                        <input type="password" name="password" id="password" class="form-control __form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="{{ translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters') }}"
                            ...
                            <div class="row d-flex">
                                <div class="col-lg-6">
                                    <div class="form-group pt-3 mb-5">
                                        <label for="customFileEg1" class="input-label">{{ translate('messages.rider_image') }}<small
...
@push('script_2')
    ...
    <script>
        ...
        // JS for earning toggle removed as the field is removed
