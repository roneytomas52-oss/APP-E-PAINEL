...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-20">
            <form class="custom-validation" action="{{ route('admin.business-settings.react-landing-page-settings', 'download-rider-app-section') }}"
    ...
    : '' }}" alt=""
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                <form
                    action="{{ route('admin.business-settings.react-landing-page-settings', 'download-rider-app-button-section') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <div class="bg-white rounded p-xxl-4 p-2">
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="form-group mb-md-0">
                                                    ...
                                                    <input type="url"
                                                           {{(isset($download_rider_app_links_data['playstore_url_status']) && $download_rider_app_links_data['playstore_url_status'])?'required':''}}
                                                           id="playstore_url"
                                                           placeholder="{{translate('Ex: https://play.google.com/store/apps')}}"
                                                           class="form-control h--45px"
                                                           name="rider_playstore_url"
                                                           value="{{ $download_rider_app_links_data['playstore_url'] ?? ''}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="bg-white rounded p-xxl-4 p-2">
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="form-group mb-md-0">
                                                    ...
                                                    <input type="url"
                                                           id="apple_store_url"
                                                           {{(isset($download_rider_app_links_data['apple_store_url_status']) && $download_rider_app_links_data['apple_store_url_status'])?'required':''}}
                                                           placeholder="{{translate('Ex: https://www.apple.com/app-store/')}}"
                                                           class="form-control h--45px"
                                                           name="rider_apple_store_url"
                                                           value="{{ $download_rider_app_links_data['apple_store_url'] ?? ''}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
