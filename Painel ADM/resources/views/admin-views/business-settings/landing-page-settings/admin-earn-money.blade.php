...
<div class="content container-fluid">
    ...
    @php($earning_rider_image=\App\Models\DataSetting::withoutGlobalScope('translate')->where('type','admin_landing_page')->where('key','earning_rider_image')->first())
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active">
            ...
            @if(addon_published_status('RideShare'))
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'earning-rider-link') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <h5 class="card-title mt-3 mb-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span> <span>{{translate('Download_Rider_App_Section')}}</span>
                    </h5>
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <label class="upload-img-3 m-0 d-block">
                                        ...
                                        <div class="img">
                                            ...
                                            <img src="{{\App\CentralLogics\Helpers::get_full_url('earning', $earning_rider_image?->value?? '', $earning_rider_image?->storage[0]?->value ?? 'public','upload_image_4')}}"

                                            data-onerror-image="{{asset('/public/assets/admin/img/upload-4.png')}}" class="vertical-img mw-100 vertical onerror-image" alt="">
                                        </div>
                                            <input class="upload-file__input single_file_input" accept="{{IMAGE_EXTENSION}}" type="file" name="earning_rider_image"  hidden>
                                                @if (isset($earning_rider_image['value']))
                                                <span id="earning_rider_img" class="remove_image_button  remove-image dynamic-checkbox"
                                                    data-id="earning_rider_img"
                                                    data-image-off="{{ asset('/public/assets/admin/img/delete-confirmation.png') }}"
                                                    data-title="{{translate('Warning!')}}"
                                                    data-text="<p>{{translate('Are_you_sure_you_want_to_remove_this_image_?')}}</p>"
                                                    > <i class="tio-clear"></i></span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="playstore_url_status"
                                                        ...
                                                        value="1" {{(isset($rider_app_links) && $rider_app_links['playstore_url_status'])?'checked':''}}>
                                                    <span class="toggle-switch-label text mb-0">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                                            </div>
                                            <input id="playstore_url_rider" type="url" placeholder="{{translate('Ex: https://play.google.com/store/apps')}}" class="form-control h--45px" name="playstore_url" value="{{ $rider_app_links['playstore_url'] ?? ''}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="apple_store_url_status"
                                                        ...
                                                        value="1" {{(isset($rider_app_links) && $rider_app_links['apple_store_url_status'])?'checked':''}}>
                                                    <span class="toggle-switch-label text mb-0">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                                            </div>
                                            <input id="apple_store_url_rider" type="url" placeholder="{{translate('Ex: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="apple_store_url" value="{{ $rider_app_links['apple_store_url']?? ''}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <form  id="earning_rider_img_form" action="{{ route('admin.remove_image') }}" method="post">
                    @csrf
                    <input type="hidden" name="id" value="{{  $earning_rider_image?->id}}" >
                    <input type="hidden" name="model_name" value="DataSetting" >
                    <input type="hidden" name="image_path" value="earning" >
                    <input type="hidden" name="field_name" value="value" >
                </form>
